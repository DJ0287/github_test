...
Public Class Frm11ALM

    Inherits FrmButton

    Private Sub Frm11_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim i As Short
        Dim twidth As Short
        Dim theight As Short
        Dim tim As Date = DateAndTime.Now
        ScrHdrLabel.Text = "故障表示画面"
        ...
        C1FlexGrid1.set_ColWidth(3, twidth * 0.8 - 2)
        C1FlexGrid1.Row = 0
        C1FlexGrid1.Col = 1
    ...
    Private Sub PasswdBtn_Click(sender As Object, e As EventArgs) Handles PasswdBtn.Click
        PopupGeneric.Label1.Text = "故障条件が復旧された表示は削除されます。よろしいですか？"
