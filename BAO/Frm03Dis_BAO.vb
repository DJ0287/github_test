...
Public Class Frm03Dis_BAO
    ...
    Private Sub Frm04_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ScrHdrLabel.Text = "Dissolution Schedule"
        Label22.Text = "ΣΔS1 upper" & vbCrLf & "setting(kg/h)"
        ...
        C1FlexGrid1.Col = 3
        C1FlexGrid1.set_ColWidth(3, twidth)
        C1FlexGrid1.Text = "Sludge" & vbCrLf & "Generation"
    ...
    Protected Overrides Sub OnUpdate()
        ...
        For J = 2 To 21
            If DISCOMBSCH.Dissolution.Count > J - 2 Then
                ...
                End If
                C1FlexGrid1.set_TextMatrix(J, 1, Format(DISCOMBSCH.Dissolution(J - 2).S1_NO3, "##0.00"))
                ...
                C1FlexGrid1.set_TextMatrix(J, 2, Format(DISCOMBSCH.Dissolution(J - 2).O2, "##0.00"))
                C1FlexGrid1.set_TextMatrix(J, 3, Format(DISCOMBSCH.Dissolution(J - 2).SL, "##0.00"))
            Else
                'For K = 0 To 5
                For K = 0 To 3
