...
Public Class Frm07Prm_BAO
    ...
    Private Sub Frm09_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ScrHdrLabel.Text = "Parameter Setting"
        ...
        C1FlexGrid1.Col = 0
        C1FlexGrid1.set_ColWidth(0, twidth * 0.5)
        'C1FlexGrid1.Text = "酸素吹き込み量"
        C1FlexGrid1.Text = "O2 Flow Rate"
        C1FlexGrid1.Col = 1
        C1FlexGrid1.set_ColWidth(1, twidth * 0.5)
        C1FlexGrid1.Text = "oxygen efficiency"
        ...
        For i = 1 To 11
            ...
            C1FlexGrid1.Col = 1
            C1FlexGrid1.CellAlignment = C1.Win.C1FlexGrid.Classic.AlignmentSettings.flexAlignCenterCenter
            C1FlexGrid1.Text = Format(PARAMETER.Search("mu" & i).設定値, "0.00")
            'C1FlexGrid1.Text = Format(PARAMETER.Table.Find("mu" & i).設定値, "0.00")
        Next
    ...
    Private Sub UpdateParam()
        ...
        For i = 1 To 11
            ...
            Catch
                ...
                MessageBox.Show("Parameter '" & "mu" & i & "' can not be found in [PARASetting.csv]")
            End Try
    ...
    Private Sub PasswdBtn_Click(sender As Object, e As EventArgs) Handles PasswdBtn.Click
        ...
        If dres = Windows.Forms.DialogResult.OK Then
            ...
            If PasswdLocked = True And PopupPasswd_BAO.TB_PASSWORD.Text.Contains(pwenable) Then
                'PopupGeneric.Label1.Text = "ロックが解除されました。入力完了後、禁止パスワードを入力してください。"
                PopupGeneric_BAO.Label1.Text = "The lock was released. Please enter lock password after completion of input."
    ...
    Private Sub EditClk(sender As Object, e As EventArgs) Handles TB_TC4.Click, TB_TC3.Click, TB_TC2.Click, TB_TC1.Click, TB_mu.Click, TB_FBSET.Click, TB_CSI.Click, TB_CAL.Click, TB_CAH.Click, TB_CAdL.Click, TB_CAdH.Click, TB_a2.Click, TB_a1.Click, TB_FASET.Click
    ...
    Private Sub C1FlexGrid1_Click(sender As Object, e As EventArgs) Handles C1FlexGrid1.Click
        ...
        If PasswdLocked = False Then
            Dim param = PARAMETER.Search("mu" & cell.Row)
            PopupSoft10Key_BAO.TB_InputLowLimit.Text = Format(param.下限値, "0.00")
            PopupSoft10Key_BAO.TB_InputUpperLimit.Text = Format(param.上限値, "0.00")
            PopupSoft10Key_BAO.TB_Input.Text = cell.Text
            If DialogResult.OK = PopupSoft10Key_BAO.ShowDialog() Then
                cell.Text = Format(Double.Parse(PopupSoft10Key_BAO.TB_Input.Text), "0.00")
